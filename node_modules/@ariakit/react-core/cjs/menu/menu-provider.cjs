...
var _RCYQROHJcjs = require('../__chunks/RCYQROHJ.cjs');


var _YRDDHZT7cjs = require('../__chunks/YRDDHZT7.cjs');
require('../__chunks/KXLF6YSN.cjs');
...
require('../__chunks/VKYTJKYN.cjs');
require('../__chunks/BRJSETQA.cjs');
require('../__chunks/IE75SSVL.cjs');
...
function MenuProvider(props = {}) {
  const store = _RCYQROHJcjs.useMenuStore.call(void 0, props);
  return /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _YRDDHZT7cjs.MenuContextProvider, { value: store, children: props.children });
}
