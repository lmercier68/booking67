...
var _WP7ZSALIcjs = require('../__chunks/WP7ZSALI.cjs');
require('../__chunks/AIPLRMQM.cjs');
...
var _M3F5A3H5cjs = require('../__chunks/M3F5A3H5.cjs');
...
var useSelect = _VKYTJKYNcjs.createHook.call(void 0, 
  (_a) => {
    var _b = _a, {
      store,
      name,
    ...
    const context = _M3F5A3H5cjs.useSelectProviderContext.call(void 0, );
    store = store || context;
    ...
    const moveOnKeyDownProp = _JTVNRMACcjs.useBooleanEvent.call(void 0, moveOnKeyDown);
    const toggleOnPressProp = _JTVNRMACcjs.useBooleanEvent.call(void 0, toggleOnPress);
    ...
    props = _JTVNRMACcjs.useWrapElement.call(void 0, 
      props,
      (element) => /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _M3F5A3H5cjs.SelectScopedContextProvider, { value: store, children: element }),
      [store]
    );
    ...
    const children = /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, _jsxruntime.Fragment, { children: [
      value,
      /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _WP7ZSALIcjs.SelectArrow, {})
    ] });
    ...
    props = _WYXAWBLEcjs.__spreadProps.call(void 0, _WYXAWBLEcjs.__spreadValues.call(void 0, {
      ...
      ref: _JTVNRMACcjs.useMergeRefs.call(void 0, store.setSelectElement, props.ref),
      onKeyDown,
      onMouseDown
    });
    props = _AET6NN6Scjs.usePopoverDisclosure.call(void 0, _WYXAWBLEcjs.__spreadValues.call(void 0, { store, toggleOnClick }, props));
    props = _TUYB72LLcjs.useCompositeTypeahead.call(void 0, _WYXAWBLEcjs.__spreadValues.call(void 0, { store }, props));
    return props;
  }
);
var Select = _VKYTJKYNcjs.createComponent.call(void 0, (props) => {
