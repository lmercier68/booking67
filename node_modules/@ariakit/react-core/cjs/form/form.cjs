...
var useForm = _VKYTJKYNcjs.createHook.call(void 0, 
  (_a) => {
    var _b = _a, {
      store,
    ...
    const defaultValues = _JTVNRMACcjs.useInitialValue.call(void 0, values);
    ...
    const onSubmit = _JTVNRMACcjs.useEvent.call(void 0, (event) => {
    ...
    const onReset = _JTVNRMACcjs.useEvent.call(void 0, (event) => {
    ...
    props = _JTVNRMACcjs.useWrapElement.call(void 0, 
      props,
      (element) => /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _P34T42GIcjs.FormScopedContextProvider, { value: store, children: element }),
      [store]
    );
    const tagName = _JTVNRMACcjs.useTagName.call(void 0, ref, props.as || "form");
...
var Form = _VKYTJKYNcjs.createComponent.call(void 0, (props) => {
  const htmlProps = useForm(props);
  return _VKYTJKYNcjs.createElement.call(void 0, "form", htmlProps);
});
