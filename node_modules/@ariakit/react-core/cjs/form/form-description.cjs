...
var useFormDescription = _VKYTJKYNcjs.createHook.call(void 0, 
  (_a) => {
    var _b = _a, { store, name: nameProp, getItem: getItemProp } = _b, props = _WYXAWBLEcjs.__objRest.call(void 0, _b, ["store", "name", "getItem"]);
...
var FormDescription = _VKYTJKYNcjs.createMemoComponent.call(void 0, 
  (props) => {
