...
var useFormRemove = _VKYTJKYNcjs.createHook.call(void 0, 
  (_a) => {
    var _b = _a, { store, name: nameProp, index, autoFocusOnClick = true } = _b, props = _WYXAWBLEcjs.__objRest.call(void 0, _b, ["store", "name", "index", "autoFocusOnClick"]);
...
var FormRemove = _VKYTJKYNcjs.createComponent.call(void 0, (props) => {
