...
var _BRJSETQAcjs = require('../__chunks/BRJSETQA.cjs');
...
function HovercardProvider(props = {}) {
  const store = _BRJSETQAcjs.useHovercardStore.call(void 0, props);
  return /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _ORT5QOHHcjs.HovercardContextProvider, { value: store, children: props.children });
}
