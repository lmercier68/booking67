...
var _PH2Q5GQRcjs = require('../__chunks/PH2Q5GQR.cjs');
...
var useCombobox = _VKYTJKYNcjs.createHook.call(void 0, 
  (_a) => {
    var _b = _a, {
      store,
      focusable = true,
    ...
    const [valueUpdated, forceValueUpdate] = _JTVNRMACcjs.useForceUpdate.call(void 0, );
    ...
    _JTVNRMACcjs.useUpdateLayoutEffect.call(void 0, () => {
      if (!inline)
        return;
      setCanInline(true);
    }, [inline]);
    ...
    _JTVNRMACcjs.useUpdateEffect.call(void 0, () => {
      var _a2;
      if (!store)
        return;
      if (!autoSelect)
    ...
    const showOnChangeProp = _JTVNRMACcjs.useBooleanEvent.call(void 0, showOnChange);
    const setValueOnChangeProp = _JTVNRMACcjs.useBooleanEvent.call(void 0, setValueOnChange);
    const onChange = _JTVNRMACcjs.useEvent.call(void 0, (event) => {
    ...
    const onCompositionEnd = _JTVNRMACcjs.useEvent.call(void 0, 
      (event) => {
        canAutoSelectRef.current = true;
    ...
    const setValueOnClickProp = _JTVNRMACcjs.useBooleanEvent.call(void 0, setValueOnClick);
    const showOnMouseDownProp = _JTVNRMACcjs.useBooleanEvent.call(void 0, showOnMouseDown);
    const onMouseDown = _JTVNRMACcjs.useEvent.call(void 0, (event) => {
    ...
    const showOnKeyDownProp = _JTVNRMACcjs.useBooleanEvent.call(void 0, showOnKeyDown);
    const onKeyDown = _JTVNRMACcjs.useEvent.call(void 0, 
      (event) => {
    ...
    const onBlur = _JTVNRMACcjs.useEvent.call(void 0, (event) => {
      canAutoSelectRef.current = false;
    ...
    props = _6MOJZWMLcjs.useComposite.call(void 0, _WYXAWBLEcjs.__spreadProps.call(void 0, _WYXAWBLEcjs.__spreadValues.call(void 0, {
      store,
      focusable
    }, props), {
    ...
    return _WYXAWBLEcjs.__spreadValues.call(void 0, { autoComplete: "off" }, props);
  }
);
var Combobox = _VKYTJKYNcjs.createComponent.call(void 0, (props) => {
