...
var _5NKFHQZ2cjs = require('../__chunks/5NKFHQZ2.cjs');
require('../__chunks/4NC3T4TV.cjs');
...
var useComboboxGroup = _VKYTJKYNcjs.createHook.call(void 0, (props) => {
  props = _5NKFHQZ2cjs.useCompositeGroup.call(void 0, props);
  return props;
});
var ComboboxGroup = _VKYTJKYNcjs.createComponent.call(void 0, (props) => {
