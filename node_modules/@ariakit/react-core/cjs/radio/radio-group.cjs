...
var _FD3VCGWPcjs = require('../__chunks/FD3VCGWP.cjs');
...
var useRadioGroup = _VKYTJKYNcjs.createHook.call(void 0, 
  (_a) => {
    var _b = _a, { store } = _b, props = _WYXAWBLEcjs.__objRest.call(void 0, _b, ["store"]);
    const context = _FD3VCGWPcjs.useRadioProviderContext.call(void 0, );
    store = store || context;
    ...
    props = _JTVNRMACcjs.useWrapElement.call(void 0, 
      props,
      (element) => /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _FD3VCGWPcjs.RadioScopedContextProvider, { value: store, children: element }),
      [store]
    );
...
var RadioGroup = _VKYTJKYNcjs.createComponent.call(void 0, (props) => {
