...
var _W23HEISMcjs = require('./W23HEISM.cjs');
...
function useFormStoreProps(store, update, props) {
  store = _W23HEISMcjs.useCollectionStoreProps.call(void 0, store, update, props);
  _WLJVTO7Acjs.useStoreProps.call(void 0, store, props, "values", "setValues");
  _WLJVTO7Acjs.useStoreProps.call(void 0, store, props, "errors", "setErrors");
  _WLJVTO7Acjs.useStoreProps.call(void 0, store, props, "touched", "setTouched");
  ...
  const useValidate = _react.useCallback.call(void 0, 
    (callback) => {
      callback = _JTVNRMACcjs.useEvent.call(void 0, callback);
  ...
  return _react.useMemo.call(void 0, 
    () => _WYXAWBLEcjs.__spreadProps.call(void 0, _WYXAWBLEcjs.__spreadValues.call(void 0, {}, store), {
      useValue,
      useValidate,
      useSubmit
    }),
...
function useFormStore(props = {}) {
  const [store, update] = _WLJVTO7Acjs.useStore.call(void 0, Core.createFormStore, props);
