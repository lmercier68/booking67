...
var _L5APETYYcjs = require('./L5APETYY.cjs');
...
function createDOMRect(x = 0, y = 0, width = 0, height = 0) {
  ...
  return _WYXAWBLEcjs.__spreadProps.call(void 0, _WYXAWBLEcjs.__spreadValues.call(void 0, {}, rect), { toJSON: () => rect });
}
...
var usePopover = _VKYTJKYNcjs.createHook.call(void 0, 
  (_a) => {
    var _b = _a, {
      store,
      modal = false,
    ...
    const { portalRef, domReady } = _JTVNRMACcjs.usePortalRef.call(void 0, portal, props.portalRef);
    const getAnchorRectProp = _JTVNRMACcjs.useEvent.call(void 0, getAnchorRect);
    const updatePositionProp = _JTVNRMACcjs.useEvent.call(void 0, updatePosition);
    ...
    props = _JTVNRMACcjs.useWrapElement.call(void 0, 
      ...
      (element) => /* @__PURE__ */ _jsxruntime.jsx.call(void 0, 
        "div",
        _WYXAWBLEcjs.__spreadProps.call(void 0, _WYXAWBLEcjs.__spreadValues.call(void 0, {
          role: "presentation"
        }, wrapperProps), {
          style: _WYXAWBLEcjs.__spreadValues.call(void 0, {
    ...
    props = _L5APETYYcjs.useDialog.call(void 0, _WYXAWBLEcjs.__spreadProps.call(void 0, _WYXAWBLEcjs.__spreadValues.call(void 0, {
      store,
      modal,
      preserveTabOrder,
      portal,
