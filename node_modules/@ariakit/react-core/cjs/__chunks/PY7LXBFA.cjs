...
var _VPDW6TOScjs = require('./VPDW6TOS.cjs');
...
function findById(items, id, baseId) {
  return items.findIndex((item, index) => {
    var _a;
    const itemId = _VPDW6TOScjs.getCollectionRendererItemId.call(void 0, item, index, baseId);
    if (itemId === id)
      return true;
    const object = getItemObject(item);
...
function useCompositeRenderer(_a) {
  ...
  store = store || context;
  const orientation = _WLJVTO7Acjs.useStoreState.call(void 0, 
    store,
  ...
  const items = _WLJVTO7Acjs.useStoreState.call(void 0, store, (state) => {
    var _a2;
    if (!state)
      return props.items;
  ...
  const activeId = _WLJVTO7Acjs.useStoreState.call(void 0, store, "activeId");
  ...
  return _VPDW6TOScjs.useCollectionRenderer.call(void 0, _WYXAWBLEcjs.__spreadProps.call(void 0, _WYXAWBLEcjs.__spreadValues.call(void 0, {
    id,
    store,
    orientation,
    persistentIndices
...
var CompositeRenderer = _VKYTJKYNcjs.forwardRef.call(void 0, function CompositeRenderer2(props) {
