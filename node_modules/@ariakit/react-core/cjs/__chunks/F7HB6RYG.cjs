...
var useCommand = _VKYTJKYNcjs.createHook.call(void 0, 
  (_a) => {
    var _b = _a, { clickOnEnter = true, clickOnSpace = true } = _b, props = _WYXAWBLEcjs.__objRest.call(void 0, _b, ["clickOnEnter", "clickOnSpace"]);
    ...
    const onKeyDown = _JTVNRMACcjs.useEvent.call(void 0, (event) => {
      ...
      if (isEnter || isSpace) {
        ...
        if (isEnter) {
          if (!nativeClick) {
            event.preventDefault();
            const _a2 = event, { view } = _a2, eventInit = _WYXAWBLEcjs.__objRest.call(void 0, _a2, ["view"]);
    ...
    const onKeyUp = _JTVNRMACcjs.useEvent.call(void 0, (event) => {
...
var Command = _VKYTJKYNcjs.createComponent.call(void 0, (props) => {
  props = useCommand(props);
  return _VKYTJKYNcjs.createElement.call(void 0, "button", props);
});
