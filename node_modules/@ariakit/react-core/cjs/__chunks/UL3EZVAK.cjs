...
var _KU7YLZWTcjs = require('./KU7YLZWT.cjs');
...
var useCheckbox = _VKYTJKYNcjs.createHook.call(void 0, 
  (_a) => {
    var _b = _a, {
      store,
      name,
    ...
    const context = _KU7YLZWTcjs.useCheckboxContext.call(void 0, );
    store = store || context;
    const [_checked, setChecked] = _react.useState.call(void 0, defaultChecked != null ? defaultChecked : false);
    const checked = _WLJVTO7Acjs.useStoreState.call(void 0, store, (state) => {
    ...
    const tagName = _JTVNRMACcjs.useTagName.call(void 0, ref, props.as || "input");
    ...
    const [propertyUpdated, schedulePropertyUpdate] = _JTVNRMACcjs.useForceUpdate.call(void 0, );
    ...
    props = _F7HB6RYGcjs.useCommand.call(void 0, _WYXAWBLEcjs.__spreadValues.call(void 0, { clickOnEnter: !nativeCheckbox }, props));
    return _WYXAWBLEcjs.__spreadValues.call(void 0, {
...
var Checkbox = _VKYTJKYNcjs.createComponent.call(void 0, (props) => {
