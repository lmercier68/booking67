...
function mergeProps(base, overrides) {
  const props = _WYXAWBLEcjs.__spreadValues.call(void 0, {}, base);
  for (const key in overrides) {
    ...
    if (key === "style") {
      const prop = "style";
      props[prop] = base[prop] ? _WYXAWBLEcjs.__spreadValues.call(void 0, _WYXAWBLEcjs.__spreadValues.call(void 0, {}, base[prop]), overrides[prop]) : overrides[prop];
      continue;
    }
