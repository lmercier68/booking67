...
function useToolbarStoreProps(store, update, props) {
  return _U74DRAW2cjs.useCompositeStoreProps.call(void 0, store, update, props);
}
function useToolbarStore(props = {}) {
  const [store, update] = _WLJVTO7Acjs.useStore.call(void 0, Core.createToolbarStore, props);
