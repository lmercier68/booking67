...
var _JVORNAMDcjs = require('./JVORNAMD.cjs');
...
function useCollectionRenderer(_a) {
  ...
  var _a2, _b2;
  const context = _JVORNAMDcjs.useCollectionContext.call(void 0, );
  store = store || context;
  const items = _WLJVTO7Acjs.useStoreState.call(void 0, 
    store,
  ...
  const baseId = _JTVNRMACcjs.useId.call(void 0, props.id);
  const horizontal = orientation === "horizontal";
  const elements = _react.useMemo.call(void 0, () => /* @__PURE__ */ new Map(), []);
  const [elementsUpdated, updateElements] = _JTVNRMACcjs.useForceUpdate.call(void 0, );
  ...
  const processVisibleIndicesEvent = _JTVNRMACcjs.useEvent.call(void 0, processVisibleIndices);
  _react.useEffect.call(void 0, () => {
  ...
  const renderOnScrollProp = _JTVNRMACcjs.useBooleanEvent.call(void 0, renderOnScroll);
  _react.useEffect.call(void 0, () => {
  ...
  const renderOnResizeProp = _JTVNRMACcjs.useBooleanEvent.call(void 0, renderOnResize);
  _react.useEffect.call(void 0, () => {
  ...
  const getItemProps = _react.useCallback.call(void 0, 
    (item, index) => {
      ...
      return _WYXAWBLEcjs.__spreadProps.call(void 0, _WYXAWBLEcjs.__spreadValues.call(void 0, _WYXAWBLEcjs.__spreadValues.call(void 0, {}, itemProps), baseItemProps), {
        style: _WYXAWBLEcjs.__spreadValues.call(void 0, _WYXAWBLEcjs.__spreadValues.call(void 0, {}, itemProps.style), baseItemProps.style)
      });
    },
  ...
  const style = _react.useMemo.call(void 0, 
    () => _WYXAWBLEcjs.__spreadValues.call(void 0, {
      flex: "none",
      position: "relative",
  ...
  return _WYXAWBLEcjs.__spreadProps.call(void 0, _WYXAWBLEcjs.__spreadValues.call(void 0, {}, props), { children });
}
var CollectionRenderer = _VKYTJKYNcjs.forwardRef.call(void 0, function CollectionRenderer2(props) {
