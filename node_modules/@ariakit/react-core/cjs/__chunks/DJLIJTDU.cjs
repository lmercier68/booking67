...
function useEventOutside({
  ...
  const callListener = _JTVNRMACcjs.useEvent.call(void 0, listener);
...
function useHideOnInteractOutside(store, hideOnInteractOutside, domReady) {
  ...
  useEventOutside(_WYXAWBLEcjs.__spreadProps.call(void 0, _WYXAWBLEcjs.__spreadValues.call(void 0, {}, props), {
    type: "click",
    listener: (event) => {
      const { contentElement } = store.getState();
