...
function useKeyboardEventProxy(store, onKeyboardEvent, previousElementRef) {
  return _JTVNRMACcjs.useEvent.call(void 0, (event) => {
    ...
    if (!canProxyKeyboardEvent(event, state))
      return;
    const _b = event, { view } = _b, eventInit = _WYXAWBLEcjs.__objRest.call(void 0, _b, ["view"]);
...
var useComposite = _VKYTJKYNcjs.createHook.call(void 0, 
  (_a) => {
    var _b = _a, {
      store,
      composite = true,
    ...
    const context = _FQGSRSYDcjs.useCompositeProviderContext.call(void 0, );
    store = store || context;
    ...
    props = _JTVNRMACcjs.useWrapElement.call(void 0, 
      props,
      (element) => /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _FQGSRSYDcjs.CompositeContextProvider, { value: store, children: element }),
      [store]
    );
    ...
    props = _WYXAWBLEcjs.__spreadProps.call(void 0, _WYXAWBLEcjs.__spreadValues.call(void 0, {
      ...
      ref: _JTVNRMACcjs.useMergeRefs.call(void 0, composite ? store.setBaseElement : null, props.ref),
      onKeyDownCapture,
      onKeyUpCapture,
      onFocusCapture,
      onFocus,
    ...
    props = _7ARL6QHNcjs.useFocusable.call(void 0, _WYXAWBLEcjs.__spreadValues.call(void 0, { focusable }, props));
    return props;
  }
);
var Composite = _VKYTJKYNcjs.createComponent.call(void 0, (props) => {
