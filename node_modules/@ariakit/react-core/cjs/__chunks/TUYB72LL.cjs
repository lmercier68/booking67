...
var useCompositeTypeahead = _VKYTJKYNcjs.createHook.call(void 0, 
  (_a) => {
    var _b = _a, { store, typeahead = true } = _b, props = _WYXAWBLEcjs.__objRest.call(void 0, _b, ["store", "typeahead"]);
...
var CompositeTypeahead = _VKYTJKYNcjs.createComponent.call(void 0, 
  (props) => {
