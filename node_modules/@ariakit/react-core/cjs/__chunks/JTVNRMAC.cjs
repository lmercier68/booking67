...
var _React = _WYXAWBLEcjs.__spreadValues.call(void 0, {}, React);
...
function useMergeRefs(...refs) {
  return _react.useMemo.call(void 0, () => {
    if (!refs.some(Boolean))
      return;
    return (value) => {
      refs.forEach((ref) => _LNE2FWJOcjs.setRef.call(void 0, ref, value));
    };
  }, refs);
}
...
function useWrapElement(props, callback, deps = []) {
  ...
  return _WYXAWBLEcjs.__spreadProps.call(void 0, _WYXAWBLEcjs.__spreadValues.call(void 0, {}, props), { wrapElement });
}
