...
function useCollectionStoreProps(store, update, props) {
  _JTVNRMACcjs.useUpdateEffect.call(void 0, update, [props.store]);
  _WLJVTO7Acjs.useStoreProps.call(void 0, store, props, "items", "setItems");
  return store;
}
function useCollectionStore(props = {}) {
  const [store, update] = _WLJVTO7Acjs.useStore.call(void 0, Core.createCollectionStore, props);
