...
var _PG7QUWN4cjs = require('./PG7QUWN4.cjs');
...
var usePortal = _VKYTJKYNcjs.createHook.call(void 0, 
  (_a) => {
    var _b = _a, { preserveTabOrder, portalElement, portalRef, portal = true } = _b, props = _WYXAWBLEcjs.__objRest.call(void 0, _b, ["preserveTabOrder", "portalElement", "portalRef", "portal"]);
    const ref = _react.useRef.call(void 0, null);
    const refProp = _JTVNRMACcjs.useMergeRefs.call(void 0, ref, props.ref);
    ...
    _JTVNRMACcjs.useSafeLayoutEffect.call(void 0, () => {
      ...
      _LNE2FWJOcjs.setRef.call(void 0, portalRef, portalEl);
      if (isPortalInDocument)
        return;
      return () => {
        portalEl.remove();
        _LNE2FWJOcjs.setRef.call(void 0, portalRef, null);
      };
...
var Portal = _VKYTJKYNcjs.createComponent.call(void 0, (props) => {
