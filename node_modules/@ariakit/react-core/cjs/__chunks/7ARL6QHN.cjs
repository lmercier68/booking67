...
function useDisableEvent(onEvent, disabled) {
  return _JTVNRMACcjs.useEvent.call(void 0, (event) => {
...
var useFocusable = _VKYTJKYNcjs.createHook.call(void 0, 
  (_a) => {
    var _b = _a, {
      focusable = true,
    ...
    const onFocusCapture = _JTVNRMACcjs.useEvent.call(void 0, (event) => {
    ...
    const autoFocusOnShow = _react.useContext.call(void 0, _75KXQZJXcjs.FocusableContext);
    const autoFocusRef = _JTVNRMACcjs.useEvent.call(void 0, (element) => {
      if (!focusable)
        return;
      if (!autoFocus)
        return;
    ...
    const tagName = _JTVNRMACcjs.useTagName.call(void 0, ref, props.as);
    const nativeTabbable = focusable && isNativeTabbable(tagName);
    const supportsDisabled = focusable && supportsDisabledAttribute(tagName);
    const style = trulyDisabled ? _WYXAWBLEcjs.__spreadValues.call(void 0, { pointerEvents: "none" }, props.style) : props.style;
    props = _WYXAWBLEcjs.__spreadProps.call(void 0, _WYXAWBLEcjs.__spreadValues.call(void 0, {
      ...
      ref: _JTVNRMACcjs.useMergeRefs.call(void 0, ref, autoFocusRef, props.ref),
      style,
...
var Focusable = _VKYTJKYNcjs.createComponent.call(void 0, (props) => {
  props = useFocusable(props);
  return _VKYTJKYNcjs.createElement.call(void 0, "div", props);
});
