...
var _IE75SSVLcjs = require('../__chunks/IE75SSVL.cjs');
...
function useCompositeOverflowStoreProps(store, update, props) {
  return _IE75SSVLcjs.usePopoverStoreProps.call(void 0, store, update, props);
}
function useCompositeOverflowStore(props = {}) {
  const [store, update] = _WLJVTO7Acjs.useStore.call(void 0, Core.createCompositeOverflowStore, props);
