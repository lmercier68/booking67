...
function TimeSlot({ practician, prestation, selectedWeek,slot ,setNewAppointment,dateTimeSlot,setDateTimeSlot,canWriteobservation,  setObservation ,userData,setUserData}) {
